;jQuery(document).ready(function($){
	...
	if ( vendors ){
		$('head').append(
			...
			+'.github-box .github-box-title{position:relative;border-bottom:1px solid #555555;border-radius:3px 3px 0 0;background:#444444;background:-moz-linear-gradient(#fcfcfc,#ebebeb);background:-webkit-linear-gradient(#fcfcfc,#ebebeb);}'
			...
			+'.github-box .github-box-download{position:relative;border-top:1px solid #555555;background:#333333;border-radius:0 0 3px 3px;padding:10px;height:auto;min-height:24px;}'
