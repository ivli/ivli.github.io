;jQuery(document).ready(function($){
	...
	if ( vendors ){
		$('head').append(
			...
			+'.github-box .github-box-download{position:relative;border-top:1px solid #555555;background:#444444;border-radius:0 0 3px 3px;padding:10px;height:auto;min-height:24px;}'
